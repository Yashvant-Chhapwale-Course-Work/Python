...
| TITLE                                                                                                                                                                                 | SECTION_LINK                                |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|
| 1.  **Day 1 : : Introduction to Python with `print()` Function**                                                                                                                      | >> <a href="#day-1" style="text-decoration: none;"> [`CHECK CONTENT`] </a> (#day-1)                |
...
| 10. **Day 10 : : `Functions With Return Values`, `Recursion` Phenomenon, `DocStrings`,<br> `Inspect` Module, `Exception Handling`in Python, Designing A `Mathematical Calculator`**   | >> [`CHECK CONTENT`](#day-10)               |
</div>
