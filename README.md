...
| 2.  **Day 2 : : An Overview On Data Types, Type Casting in Python with `int()`, `float()` & `str()` Function, Using `input()` Function To Take User Inputs**                          | >> [`CHECK CONTENT`](#day-2)                |>> [`VIEW PROJECT`](https://github.com/Yashvant-Chhapwale-Course-Work/Python/tree/main/Day_2) |   
