...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------|---------------------------------------------------|
| 1.  **Day 1 : : Introduction to Python with `print()` Function**                                                                                                                       | >> [`TO SECTION`](#day-1)            |>> [`TO PROJECT`](https://github.com/Yashvant-Chhapwale-Course-Work/Python/tree/main/Day_1) |
| 2.  **Day 2 : : An Overview On Data Types, Type Casting in Python with `int()`, `float()` & `str()` Function,<br> Using `input()` Function To Take User Inputs**                       | >> [`TO SECTION`](#day-2)            |>> [`TO PROJECT`](https://github.com/Yashvant-Chhapwale-Course-Work/Python/tree/main/Day_2) |   
| 3.  **Day 3 : : `if-elif-else` Statements**                                                                                                                                            | >> [`TO SECTION`](#day-3)            |>> [`TO PROJECT`](https://github.com/Yashvant-Chhapwale-Course-Work/Python/tree/main/Day_3) |
| 4.  **Day 4 : : `List` and `Loops` with Python**                                                                                                                                       | >> [`TO SECTION`](#day-4)            |>> [`TO PROJECT`](https://github.com/Yashvant-Chhapwale-Course-Work/Python/tree/main/Day_4) |
| 5.  **Day 5 : : Fun with `range()` Function**                                                                                                                                          | >> [`TO SECTION`](#day-5)            |>> [`TO PROJECT`](https://github.com/Yashvant-Chhapwale-Course-Work/Python/tree/main/Day_5) |
| 6.  **Day 6 : : `Python Functions` with `Reeborg Maze Challenge`**                                                                                                                     | >> [`TO SECTION`](#day-6)            |>> [`TO PROJECT`](https://github.com/Yashvant-Chhapwale-Course-Work/Python/tree/main/Day_6) |
| 7.  **Day 7 : : `Python Modules`, `The Hangman` Game**                                                                                                                                 | >> [`TO SECTION`](#day-7)            |>> [`TO PROJECT`](https://github.com/Yashvant-Chhapwale-Course-Work/Python/tree/main/Day_7) |
| 8.  **Day 8 : : `Parameterized Functions`, `Name Shadowing` Phenomenon, Implementing `Caesar Cipher`**                                                                                 | >> [`TO SECTION`](#day-8)            |>> [`TO PROJECT`](https://github.com/Yashvant-Chhapwale-Course-Work/Python/tree/main/Day_8) |
| 9.  **Day 9 : : `Python Dictionaries`, A `Blind Auction System`**                                                                                                                      | >> [`TO SECTION`](#day-9)            |>> [`TO PROJECT`](https://github.com/Yashvant-Chhapwale-Course-Work/Python/tree/main/Day_9) |
| 10. **Day 10 : : `Functions With Return Values`, `Recursion` Phenomenon, `DocStrings`, `Inspect` Module, `Exception Handling`in Python, Designing A `Mathematical Calculator`**        | >> [`TO SECTION`](#day-10)           |>> [`TO PROJECT`](https://github.com/Yashvant-Chhapwale-Course-Work/Python/tree/main/Day_10)|
</div>
